// --- Satin Alma Faturasi JS ---
frappe.ui.form.on('Satin Alma Faturasi', {
    onload: function (frm) {
    ...
    refresh: function (frm) {
        ...
        if (frm.doc.docstatus === 1 && frm.doc.status !== "Ödendi" && frm.doc.status !== "İptal") {
            frm.add_custom_button(__('Ödeme Yap'), function () {
                frappe.model.open_mapped_doc({
                    method: "archerp.satin_alma.doctype.satin_alma_faturasi.satin_alma_faturasi.make_payment_entry",
                    frm: frm
                })
            }, __('Oluştur'));
        }
...
frappe.ui.form.on('Satin Alma Fatura Kalemi', {
